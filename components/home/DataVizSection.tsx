...
export const DataVizSection: React.FC = () => {
  ...
  return (
    <section id="analytics" className="py-20 sm:py-28 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white relative overflow-hidden transition-colors border-y border-slate-200/80 dark:border-slate-800">
      {/* Background Decor */}
      ...
      <Container>
        <div className="flex flex-col items-center text-center mb-12">
          <span className="px-3.5 py-1 rounded-full text-xs font-semibold bg-blue-500/10 dark:bg-blue-500/20 text-blue-600 dark:text-blue-300 border border-blue-500/20 dark:border-blue-500/30 mb-4 flex items-center gap-1.5">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tight">
            Data-Driven <span className="bg-linear-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent">Capability Growth</span>
          </h2>
        ...
        <motion.div
          ...
          className="bg-white dark:bg-slate-800/90 border border-slate-200/80 dark:border-slate-700/80 rounded-3xl p-6 sm:p-10 backdrop-blur-xl shadow-xl shadow-slate-200/50 dark:shadow-2xl"
        >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-700/80 pb-4">
                  ...
                  <div className="flex items-center gap-4 text-xs font-bold">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-slate-600 dark:text-slate-300">Baseline Compensation</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-3 h-3 rounded-full bg-blue-600 dark:bg-blue-500" />
                      <span className="text-blue-600 dark:text-blue-400">Post-Upskilling Compensation</span>
                    </div>
                  </div>
                </div>
