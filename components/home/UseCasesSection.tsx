              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div className="lg:col-span-7 flex flex-col gap-5">
                  ...
                  <div className="flex flex-col gap-2.5 pt-2">
                    {currentIndustry.highlights.map((item, idx) => (
                      <motion.div
                        key={item}
                        initial={{ opacity: 0, x: -10 }}
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.3, delay: idx * 0.08 }}
                        className="flex items-center gap-2.5 text-[13px] font-medium text-[#334155]"
                      >
                  ...
                  <div className="pt-4">
                    <motion.button
                      ...
                      className="inline-flex items-center justify-center gap-2 h-13 px-7 rounded-2xl bg-[#0F172A] hover:bg-[#1E293B] text-white font-bold text-[14px] transition-colors duration-200 shadow-md active:scale-[0.98] cursor-pointer"
                    >
                ...
                <div className="lg:col-span-5 flex flex-col gap-4">
                  {currentIndustry.metrics.map((m, idx) => (
                    <motion.div
                      ...
                      className="p-6 rounded-2xl bg-[#FAFBFD] border border-[#E5E7EB] flex flex-col gap-1 hover:border-blue-200 transition-colors"
                    >
