    ...
    <section id="testimonials" className="py-20 sm:py-28 bg-slate-50/50">
      <Container>
        <SectionHeading
          ...
          subtitle="Discover how top Fortune 500 companies drive continuous capability transformation with Accredian."
        />
        ...
        <div className="max-w-4xl mx-auto">
          <Card
            variant="glass"
            padding="lg"
            className="relative shadow-2xl border-slate-200/80 bg-white"
          >
            <div className="flex items-center justify-between mb-8 pb-6 border-b border-slate-100">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-2xl bg-blue-600 text-white font-black text-xl flex items-center justify-center shadow-md shadow-blue-600/30">
                  {activeTestimonial.companyLogo.charAt(0)}
                </div>
                <div>
              ...
              {activeTestimonial.impactMetrics && (
                <div className="hidden sm:flex items-center gap-2 bg-emerald-50 text-emerald-700 border border-emerald-200/60 px-3.5 py-1.5 rounded-xl text-xs font-bold">
                ...
                <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="p-2.5 rounded-xl border border-slate-200 hover:border-blue-600 bg-white text-slate-600 hover:text-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
